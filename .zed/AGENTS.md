# Mangrove Development Rules — Zed
...
13 MCP servers configured in `~/.config/zed/settings.json`. Python servers use GRID venv at `/home/caraxes/roots/GRID/.venv/bin/python`.
