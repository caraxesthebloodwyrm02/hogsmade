...
import { ResolutionWorkbenchView } from "./ResolutionWorkbenchView";
...
const VIEWS: { id: View; label: string; description: string }[] = [
  ...
  { id: "topology", label: "Topology", description: "MCP graph & health" },
  {
    id: "context",
    label: "Context",
    description: "Keyword search & interview",
  },
  { id: "resolution", label: "Resolver", description: "Endpoint workbench" },
  {
    id: "evolution",
    label: "Evolution",
    description: "Eligibility promotion control room",
  },
  {
    id: "cognition",
    label: "Cognition",
    description: "Pattern radar & GATE flow",
  },
  ...
  return (
    <div className="h-screen flex flex-col bg-canvas-bg">
      ...
      >
        ...
        {activeView === "resolution" && <ResolutionWorkbenchView />}
