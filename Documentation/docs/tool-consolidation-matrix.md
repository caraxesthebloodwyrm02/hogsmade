...
| -------------------------- | --------- | ------------------------------------- | ------------------ | ------------------ | ------- | ---------------- | ------- |
| Repository layout          | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
| Build/test commands        | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
| Coding style               | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
| Testing conventions        | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
| Commits and PRs            | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
| Security/git hygiene       | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
| TUV-001 governance         | canonical | pointer                               | pointer            | — (uses rules)     | pointer | pointer          | pointer |
