...
1. **Verify Git Tree:** Use Option 1 (*Git Tree Status*) to guarantee no accidental untracked system files have sneaked into the queue.
2. **Consult Deepwiki:** Use Option 4 (*Code Review & Deepwiki Recommendations*) to ensure newly authored modules are not violating Python Async blocking constraints or JS/TS React prop-drilling warnings defined by the parent hierarchy.
