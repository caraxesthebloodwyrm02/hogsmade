...
const data = [
  {
    ...
    year: 1831,
    contribution: "Electromagnetic induction",
    domain: "physics",
    location: "London",
  },
  {
    name: "Charles Darwin",
    year: 1859,
    contribution: "Theory of natural selection",
    domain: "biology",
    location: "England",
  },
  {
    ...
    year: 1865,
    contribution: "Unified electromagnetic theory",
    domain: "physics",
    location: "London",
  },
  {
    name: "Gregor Mendel",
    year: 1866,
    contribution: "Laws of inheritance",
    domain: "biology",
    location: "Austria",
  },
  {
    name: "Nikola Tesla",
    year: 1888,
    contribution: "Alternating current motor",
    domain: "engineering",
    location: "US",
  },
  {
  ...
  },
  {
    name: "Alan Turing",
    year: 1936,
    contribution: "Computability theory",
    domain: "computing",
    location: "England",
  },
  {
  ...
  },
  {
    name: "Yoshua Bengio",
    year: 2006,
    contribution: "Deep learning foundations",
    domain: "computing",
    location: "Canada",
  },
  {
    ...
    year: 2012,
    contribution: "CRISPR gene editing",
    domain: "biology",
    location: "United States",
  },
];
...
const config = {
  ...
  taxonomy: {
    domains: [
      ...
      },
      {
        id: "mathematics",
        label: "Mathematics",
        keywords: ["theory", "information", "logic", "proof", "formula", "equation"],
      },
      {
        id: "engineering",
        label: "Engineering",
        keywords: ["motor", "current", "electrical", "design", "system", "alternating"],
      },
    ],
  },
  defaults: {
  ...
  rules: [
    ...
    },
    {
      ...
      priority: 80,
      function: "taxonomy_score",
      args: { path: "entity.domain_keyword_hits", domain: "biology", min_score: 1 },
      returns: "score",
      weight_strategy: "direct_score",
      derive: [
    ...
    {
      id: "rule-math",
      label: "Mathematics domain",
      applies_to: "entity",
      priority: 80,
      function: "taxonomy_score",
      args: { path: "entity.domain_keyword_hits", domain: "mathematics", min_score: 1 },
      returns: "score",
      weight_strategy: "direct_score",
      derive: [{ action: "boost_lens", lens: "mathematics", score: 0.9 }],
    ...
    },
    {
      ...
      priority: 80,
      function: "taxonomy_score",
      args: { path: "entity.domain_keyword_hits", domain: "engineering", min_score: 1 },
      returns: "score",
      weight_strategy: "direct_score",
      derive: [{ action: "boost_lens", lens: "engineering", score: 0.9 }],
      affects: ["context_lens"],
    },
    {
      id: "rule-time-dim",
      label: "Has time dimension",
      applies_to: "dataset",
      priority: 60,
    ...
    },
    {
      ...
      returns: "score",
      weight_strategy: "direct_score",
      derive: [{ action: "prefer_view", view: "clusters", score: 0.5 }],
      affects: ["view"],
    },
    {
      id: "rule-size",
...
console.log(
  `  Time: ${result.profile.timeRange?.min || "?"} - ${result.profile.timeRange?.max || "?"}\n`,
);
...
if (result.invariantPatterns.length === 0) {
  ...
  result.invariantPatterns.slice(0, 5).forEach((p, i) => {
    ...
    console.log(
      `     Density: ${p.densityScore} | Domains: ${p.domainCount} | Tokens: ${p.tokenCount}`,
    );
  });
}
console.log();
