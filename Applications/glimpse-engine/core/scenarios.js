  ...
  data: [
    {
      person: "Rahim",
      date: "2026-03-14",
      yesterday: "Fixed auth bug in login flow",
      today: "Start payment gateway integration",
      blockers: "Waiting on API credentials from Stripe",
      mood: "focused",
      tags: ["auth", "payments", "backend"],
    },
    {
      person: "Ayesha",
      date: "2026-03-14",
      yesterday: "Completed dashboard redesign mockups",
      today: "Implement new chart components",
      blockers: "None",
      mood: "energized",
    ...
    },
    {
      person: "Kamal",
      date: "2026-03-14",
      yesterday: "Reviewed PRs, fixed CI pipeline",
      today: "Database migration for user preferences",
      blockers: "Migration script needs testing on staging",
      mood: "cautious",
      tags: ["devops", "database", "ci"],
    },
    {
      person: "Nadia",
      date: "2026-03-14",
      yesterday: "Wrote unit tests for notification service",
      today: "Integration tests for email + SMS",
      blockers: "SMS provider sandbox is down",
      mood: "frustrated",
      tags: ["testing", "notifications", "integrations"],
    },
    {
      person: "Tariq",
      date: "2026-03-14",
      yesterday: "Optimized search query performance",
      today: "Add caching layer for frequent queries",
      blockers: "Redis cluster config unclear",
      mood: "thinking",
      tags: ["performance", "search", "caching"],
    },
  ],
  config: {
    functions: {},
  ...
  display(session) {
    ...
    entries.forEach((entry) => {
      ...
      d.row(
        d.icon(entry.mood),
        entry.person,
        `${entry.mood.padEnd(12)} → ${entry.today}${blockerFlag}`,
        { padLabel: 10 },
      );
    });
...
register("energy", {
  ...
  data: [
    {
      ...
      clarity: 8,
      mood: "peaceful",
      notes: "Good start, slept well",
      category: "spiritual",
    },
    {
      time: "08:00",
      activity: "Deep work — GRID refactor",
      energy: 9,
      clarity: 9,
      mood: "focused",
      notes: "Flow state for 2 hours",
      category: "work",
    },
    {
      time: "10:30",
    ...
    },
    {
      ...
      clarity: 6,
      mood: "recovering",
      notes: "Needed the break",
      category: "rest",
    },
    {
      time: "14:00",
      activity: "Glimpse engine work",
      energy: 7,
      clarity: 7,
      mood: "creative",
      notes: "Good progress on interview module",
      category: "work",
    },
    {
      time: "16:00",
    ...
    {
      time: "18:00",
      activity: "Evening prayer + reflection",
      energy: 5,
      clarity: 7,
      mood: "contemplative",
  ...
  display(session) {
    ...
    Object.entries(categories).forEach(([cat, data]) => {
      d.kv(
        cat.padEnd(12),
        `${data.count} blocks  avg energy ${(data.energy / data.count).toFixed(1)}`,
      );
    });
  },
});
...
register("portfolio", {
  ...
  data: [
    ...
    },
    {
      ...
      revenue: 0,
      effort: "high",
      tags: ["javascript", "visualization", "decision-support"],
    },
    {
      name: "MCP Services",
      status: "active",
    ...
    },
    {
      ...
      revenue: 280,
      effort: "done",
      tags: ["typescript", "frontend", "client-work"],
    },
  ],
  config: {
    functions: {},
...
register("lending", {
  ...
  data: [
    {
      ...
      amount: 50000,
      currency: "BDT",
      reason: "Business startup — opening a phone repair shop",
      urgency: "moderate",
      timeline: "needs it within 2 weeks",
      relationship: "close family",
      tags: ["family", "business", "lending"],
    },
    {
      type: "history",
      from: "Cousin Farhan",
      ...
      repaid: 1,
      outstanding: 15000,
      lastRepayment: "2025-11-01",
      notes: "Paid back first loan on time, second one still pending",
      tags: ["history", "track-record"],
    },
    {
      type: "your-finances",
      monthlyIncome: 35000,
      ...
      emergencyFund: 80000,
      notes: "Can afford it but would dip into emergency fund",
      tags: ["personal-finance", "capacity"],
    },
    {
      type: "market-context",
      businessViability: "moderate",
      localDemand: "phone repairs are in demand in the area",
      competition: "2 existing shops within 1km",
      notes: "Viable but competitive market",
      tags: ["market", "business-viability"],
    },
    {
      type: "emotional-factor",
      pressure: "family expectations to help",
      guilt: "moderate — he helped during your job search",
      relationship_risk: "saying no could create tension",
      notes: "Social obligation is real but shouldn't override financial sense",
      tags: ["emotional", "social", "family-dynamics"],
    },
  ],
  config: {
    functions: {},
  ...
  display(session) {
    ...
    if (analysis.summary.topStrength) {
      d.signal(
        `Top strength: ${analysis.summary.topStrength.label} — ${analysis.summary.topStrength.detail}`,
      );
    }
  },
});
...
register("recommend", {
  ...
  data: [
    ...
    {
      task: "Migrate to new auth provider",
      priority: "high",
      effort: "large",
      deadline: "2026-03-22",
      domain: "backend",
      blockedBy: "Fix login timeout bug",
      impact: "high",
      tags: ["migration", "auth", "infrastructure"],
    },
    {
    ...
    {
      task: "Refactor notification service",
      priority: "low",
      effort: "medium",
      deadline: null,
      domain: "backend",
      blockedBy: null,
      impact: "low",
      tags: ["refactor", "notifications", "tech-debt"],
    },
    {
      ...
      deadline: "2026-03-14",
      domain: "business",
      blockedBy: "Implement dashboard charts",
      impact: "high",
      tags: ["client", "demo", "deadline"],
    },
  ],
  config: {
    functions: {},
