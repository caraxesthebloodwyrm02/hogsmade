      ...
      >
        ...
        <div className="p-4 space-y-5">
          ...
          <div className="space-y-2">
            <div className="text-xs text-ink-muted font-body uppercase tracking-wider">
              Envelope
            </div>
          ...
          {/* Step breakdown */}
          <div>
            <div className="text-xs text-ink-muted font-body uppercase tracking-wider mb-3">
              Step Breakdown
            </div>
...
export function GateView() {
  const { verifications, auditEvents, nonces, deployments, loading, debugContext } = useGateData();
  ...
  return (
    <div className="h-full overflow-y-auto bg-canvas-bg dot-grid font-body">
      <header className="px-6 py-5 border-b border-border-color bg-[var(--glass-fill)] backdrop-blur-xl shadow-token-sm relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="font-mono text-[10px] uppercase tracking-[0.14em] text-ink-muted mt-1">
            <span className="text-teal-500">⊞</span> Envelope verification, audit trail, nonce
            registry, and deployment history. Read-only.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-8">
        {debugContext && (
          <section aria-label="Debug trace context" className="glass-panel p-4">
        ...
        <section aria-labelledby="audit-heading">
          ...
          <div className="glass-panel p-4">
            <AuditTimeline events={loading ? [] : auditEvents} loading={loading} pageSize={5} />
          </div>
        </section>
                    ...
                    nonces.map((n) => {
                      ...
                      return (
                        <tr key={n.nonce} className="border-b border-border-color last:border-0">
                          <td className="text-sm text-ink px-4 py-2 font-mono">{n.nonce}</td>
